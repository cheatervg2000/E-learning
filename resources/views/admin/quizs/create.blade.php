...
<div class="content-wrapper">
    ...
    @include('partials.content-header', ['name' => 'Câu hỏi', 'key' => 'Thêm mới'])
    <!-- /.content-header -->
    <!-- Main content -->
            ...
            <div class="container-fluid">
                <div class="column">
                    <div class="col-md-6">
                        ...
                        @csrf
                        <input type="text" class="form-control d-none" name="lesson_id" value="{{ $lesson->id }}">
                        <input type="text" class="form-control d-none" name="chapter_id" value="{{ $lesson->chapter_id }}">
                        <div class="mb-3">
                            <label>Tên bài học <span style="color: red">*</span></label>
                            <input disabled type="text" class="form-control" name="lesson_name" value="{{ $lesson->name }}">
                        </div>
