    ...
    @else
        <div class="content">
            ...
            <div class="title">
                ...
                <h4 class="text-center mt-4" >Bài học số </h4>
            </div>
            <div class="test mt-5">
                <h5 class="text-center">Bài kiểm tra cuối bài học</h5>
                <h6 class="text-center">Số lượng câu hỏi:</h6>
            ...
            <div class="m-lg-5" id="ok">
                <h6 class="text-danger" style="margin-left: 10%">CHỌN MỘT ĐÁP ÁN ĐÚNG CHO MỖI CÂU HỎI DƯỚI ĐÂY:</h6>
                <form action="{{route('lesson_check_answer',[$result[0]->course_id, $result[0]->lesson_id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @foreach($result as $item)
                        <div class="form-group mt-3" id="quiz" style="margin-left: 10%; clear: both">
                            <h6>
